        ...
        <nav className='overflow-hidden'>
            <ul className='flex max-w-[100vw] overflow-x-auto mt-4 gap-4 md:gap-12 pl-1 pr-6 font-semibold'>
                ...
                <li className={`flex-shrink-0 pb-1 px-1 relative `}>
                    ...
                    <div className={`absolute bottom-0 duration-500 border-b-2 translate-x-[-50%] left-[50%] border-black ${pathname?.indexOf('/ComponentLibrary') === 0 ? 'w-full duration-500' : 'w-0 duration-150'}`}></div>
                </li>
                <li className={`flex-shrink-0 pb-1 px-1 relative `}>
