...
const page = () => {
  return (
    <div className='flex-1 bg-slate-100'>
        <h3 className='ml-2 text-gray-700 text-sm mt-1'>Tranform, Optimize, Next.js ready</h3>
        <div className='relative w-[80%] aspect-[2/3] object-cover mx-auto mt-4'>
            <Image src={ExampleImage} fill alt='An example'/>
        </div>
        <div className='w-full flex'>
            <button className='mx-auto text-2xl font-semibold'>+</button>
        </div>
        ...
        <div className='grid grid-cols-[35%,_20%,_20%,_20%,_20%] col max-w-full overflow-x-auto mt-1 pl-1 font-semibold'>
